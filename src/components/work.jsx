...
export default function WorkExperience({ experience, experienceChange, addExperience, removeExperience, addBullet, removeBullet }) {
    return (
...
function Job({ job, index, experienceChange, addBullet, removeExperience, removeBullet }) {
    return(
        <div className="container-experience">
            <h2>Experience {index + 1} {index === 0 && <span className="recent">Most recent first</span>}</h2>
            ...
            <div className="container-input-fields">
                <label htmlFor="duration" className="job-label">
                    ...
                    <input
                        ...
                        className="job-input"
                        value={job.duration}
                        onChange={(e) => experienceChange(index, "duration", e.target.value)}    
                    />
                </label>
...
function BulletPoint({ bullet, bulletIndex, removeBullet, experienceChange, jobIndex }) {
    return (
        <div className="container-input-fields">
            <input
                type="text"
                ...
                className="job-input"
                value={bullet}
                onChange={(e) => experienceChange(jobIndex, "bullets", e.target.value, bulletIndex)}
            />
            <button
