      ...
      <div className="container-input">
        <label htmlFor="fullName" className="personal-label">
          ...
          <input
            ...
            onChange={(e) =>
              onChange({ ...personalDetails, fullName: e.target.value })
            }
          />
        </label>
        <label htmlFor="job-title" className="personal-label">
          ...
          <input
            ...
            onChange={(e) =>
              onChange({ ...personalDetails, jobTitle: e.target.value })
            }
          />
        </label>
      </div>
      <div className="container-input">
        <label htmlFor="email" className="personal-label">
          ...
          <input
            ...
            onChange={(e) =>
              onChange({ ...personalDetails, email: e.target.value })
            }
          />
        </label>
        <label htmlFor="phone" className="personal-label">
          ...
          <input
            ...
            onChange={(e) =>
              onChange({ ...personalDetails, phone: e.target.value })
            }
          />
        </label>
      </div>
      <div className="container-input">
        <label htmlFor="address" className="personal-label">
          ...
          <input
            ...
            onChange={(e) =>
              onChange({ ...personalDetails, address: e.target.value })
            }
          />
        </label>
      </div>
      <div className="container-input">
        <label htmlFor="about" className="personal-label">
          ...
          <textarea
            ...
            onChange={(e) =>
              onChange({ ...personalDetails, about: e.target.value })
            }
          ></textarea>
        </label>
      </div>
