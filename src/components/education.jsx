...
export default function Education({ education, educationChange, addEducation, removeEducation, addBullet, removeBullet}) {
    return (
...
function Degree({degree, index, educationChange, removeEducation, addBullet, removeBullet }) {
    return(
            ...
            <div className="container-input-fields">
                <label htmlFor="university" className="degree-label">
                    ...
                    <input
                        ...
                        onChange={(e) => educationChange(index, "university", e.target.value)}
                    />
                </label>
            ...
            <div className="container-input-fields">
                <label htmlFor="duration" className="degree-label">
                    ...
                    <input
                        ...
                        onChange={(e) => educationChange(index, "graduation", e.target.value)}
                    />
                </label>
...
function BulletPoint({ bullet, bulletIndex, removeBullet, educationChange, degreeIndex }) {
    return (
        <div className="container-input-fields">
            <input
                type="text"
                ...
                className="degree-input"
                value={bullet}
                onChange={(e) => educationChange(degreeIndex, "bullets", e.target.value, bulletIndex)}
            />
            <button
